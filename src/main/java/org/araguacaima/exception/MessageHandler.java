package org.araguacaima.exception;

import org.araguacaima.utils.FileUtils;
import org.araguacaima.utils.SystemInfo;
...
public class MessageHandler {
     ...
     * ej: getValue("A {0} B {1}", { "C", "D" }) -> "A C B D"
     ...
     *                      forma <fileName>_<localeId> o <tableName>_<localeId>
     */
