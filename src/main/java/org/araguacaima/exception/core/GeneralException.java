...
import org.araguacaima.exception.MessageHandler;

/**
 * Clase principal del modulo de manejo de excepciones (org.araguacaima.exception).
...
public abstract class GeneralException extends RuntimeException {
    ...
    /**
     * Create an GeneralException of a given {@link org.araguacaima.exception.core.Severity} with a message detailing it
     *
     * @param code     String
    ...
    protected GeneralException(String code, Severity severity, String extendedMessage) {
        super(Exceptions.getMessage(code) + ((extendedMessage == null || extendedMessage.equals("")) ? "" : " " + extendedMessage));
        this.severity = severity;
        this.code = code;
