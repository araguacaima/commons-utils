...
import org.araguacaima.exception.core.Exceptions;
import org.araguacaima.exception.core.Severity;
import org.araguacaima.exception.core.TechnicalException;
...
public class NumberUtils {
    ...
    /**
     * @deprecated Usar directamente formatNumber(...)
     */
    public String decimalFormat(double valor) {
        // TODO: Hacer inline del metodo
    ...
    public Double divide(Double dividendo, Double divisor) {
        return (null == dividendo && null == divisor) ? null : ((null == dividendo) ? new Double(1 / divisor) : ((null == divisor) ? dividendo : new Double(dividendo / divisor)));
    }
    ...
    public String format(Double n) {
        // TODO: Hacer inline del metodo
        // return (null == n) ? null /* "" */ : format(n.doubleValue());
        // return decimalFormatter.format(n);
        return formatNumber(n);
    }
    ...
    // Fin de Metodos de NumberUtil de SICAM ----------------- ELIMINAR

    /**
     * @deprecated Usar directamente formatNumber(...)
     */
    public String formateaDouble(Double valorDouble) {
        // TODO: Hacer inline del metodo
        // return (valorDouble == null) ? "" : NumberUtil.decimalFormat(valorDouble.doubleValue());
        return formatNumber(valorDouble);
    }
    ...
    /****************************************************
     * Operaciones basicas sobre los Number
     ****************************************************/
    ...
    public Double subtract(Double mm, Double ss) {
        return (null == mm && null == ss) ? null : ((null == mm) ? new Double(-ss) : ((null == ss) ? mm
                : new Double(mm - ss)));
    }
