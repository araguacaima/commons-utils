...
public class JDlgFont extends JDialog implements ItemListener, ActionListener {
    ...
    public void itemStateChanged(ItemEvent e) {
        Font PreviewFont = new Font((String) (faces.getSelectedItem()), Font.PLAIN, PREVIEW_SIZE);

        CurFont = new Font((String) (faces.getSelectedItem()), Font.PLAIN, OPTIMUM_SIZE);
