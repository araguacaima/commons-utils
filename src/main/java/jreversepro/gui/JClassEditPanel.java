...
public class JClassEditPanel extends JPanel {
    private static Logger log = LoggerFactory.getLogger(JClassEditPanel.class);
    /**
    ...
    public boolean writeToFile(JFrame aParent, File aOutputFile) {
        ...
        try {
            ...
            PrOut = null;
            out = null;
            String Msg = "Contents written onto " + aOutputFile.toString() + " successfully";
            JOptionPane.showMessageDialog(aParent, Msg, "File Saved", JOptionPane.INFORMATION_MESSAGE);
            return true;
        } catch (Exception _ex) {
     ...
     */
    public void createModel(JFrame aParent, String aFileName, List aChildren) {
