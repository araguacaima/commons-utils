...
public class JErrorDlg extends JDialog implements ActionListener {
    ...
    private void addComponents() {
        ...
        BtnOk.setBounds(0, (int) (0.25 * HEIGHT), (int) (0.3 * WIDTH), (int) (0.1 * HEIGHT));
        BtnDetails.setBounds((int) (0.6 * WIDTH), (int) (0.25 * HEIGHT), (int) (0.3 * WIDTH), (int) (0.1 * HEIGHT));
