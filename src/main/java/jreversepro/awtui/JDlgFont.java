...
public class JDlgFont extends Dialog implements ItemListener, ActionListener {

    private static Logger log = LoggerFactory.getLogger(JDlgFont.class);
    ...
    public Font getChosenFont() {
        return new Font(fontNames[fontIndex], Font.PLAIN, OPTIMUM_SIZE);
    }
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        LblTest.setText("");
        Font PreviewFont = new Font(fontNames[fontIndex], Font.PLAIN, PREVIEW_SIZE);

        log.info("Setting font " + PreviewFont.toString());
    ...
    private void fillFontObjects() {
        ...
        log.info("Array Length " + fontNames.length);
