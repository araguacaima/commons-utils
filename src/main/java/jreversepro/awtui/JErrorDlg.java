...
public class JErrorDlg extends Dialog implements ActionListener {
    ...
    private void addComponents() {
        ...
        TxtDetails.setBounds(0, (int) (0.25 * HEIGHT), WIDTH, (int) (0.5 * HEIGHT));
        BtnOk.setBounds(0, (int) (0.8 * HEIGHT), (int) (0.3 * WIDTH), (int) (0.1 * HEIGHT));
        BtnCancel.setBounds((int) (0.6 * WIDTH), (int) (0.8 * HEIGHT), (int) (0.3 * WIDTH), (int) (0.1 * HEIGHT));
        add(TxtDetails);
        add(BtnOk);
        add(BtnCancel);
    }
