...
public class JCustomFileChooser extends FileDialog {
     ...
     */
    public JCustomFileChooser(Frame parent, String aTitle, String aFileExtension, String aDir, int mode) {
    ...
    class CustomFileFilter implements java.io.FilenameFilter {
         ...
         *         false, otherwise.
         */
        public boolean accept(File aFilterFile, String aName) {
            return (aFilterFile.isDirectory() || aFilterFile.getName().endsWith(mFileExtension));
        }
    }
}