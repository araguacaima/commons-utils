 ...
 */
public class JAwtFrame extends Frame implements ActionListener, KeyWords, WindowListener, AppConstants {

    private static Logger log = LoggerFactory.getLogger(JAwtFrame.class);
    /**
    ...
    public synchronized void openFile() {
        JCustomFileChooser chooser = new JCustomFileChooser(this, "Open File", ".class", mCurDir, FileDialog.LOAD);
        ...
        if (f != null) {
            ...
            try {
                reverseEngineer(new File(mCurDir + f));
            } catch (Exception _ex) {
    ...
    private synchronized void reverseEngineer(File aFile) throws ClassParserException, IOException, RevEngineException {
        ...
        classInfo.reverseEngineer(!mMbrGen.OnDisAssembler.getState());
        mPnlEditor.writeCode(classInfo.getStringifiedClass(!mMbrGen.OnDisAssembler.getState()));
    ...
    public void saveFile() {
        JCustomFileChooser chooser = new JCustomFileChooser(this, "Open File", ".class", mCurDir, FileDialog.SAVE);
        chooser.setVisible(true);
        String f = chooser.getFile();
        if (f != null) {
...
//        }
    ...
    private void saveProperties() {
        try {
            Properties pp = new Properties();
            pp.setProperty(DECOMPILE_FLAG, String.valueOf(!mMbrGen.OnDisAssembler.getState()));
