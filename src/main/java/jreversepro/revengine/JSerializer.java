...
public class JSerializer implements KeyWords {
    ...
    private static Logger log = LoggerFactory.getLogger(JSerializer.class);
     ...
     */
    public JClassInfo loadClass(File file) throws ClassParserException, IOException {
     ...
     *                              error or not a class file.
     */
    public JClassInfo loadClass(URL url) throws ClassParserException, IOException {
