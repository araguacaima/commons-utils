...
public class JBranchTable implements BranchConstants, JJvmOpcodes {
     ...
     */
    public void identifyMoreBranches() throws RevEngineException {
    ...
    public int findGotoTarget(int startPc) {
        Object obj = gotos.get(new Integer(startPc));
        if (obj == null) {
            return -1;
        } else {
     ...
     */
    public List startsWith(int aInsIndex) throws RevEngineException {
