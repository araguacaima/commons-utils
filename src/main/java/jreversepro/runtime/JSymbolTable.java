...
public class JSymbolTable implements KeyWords {
        ...
        while (enumValues.hasMoreElements()) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if (!ent.isDeclared() && ent.getLastReferredIndex() > endOfBranch) {
                    ...
                    String type = imports.getClassName(Helper.getJavaDataType(ent.getDeclarationType(), false));
     ...
     */
    public String getName(int aVarIndex, int aInsIndex) throws RevEngineException {
     ...
     * @throws RevEngineException Thrown in case of any problem.
     */
    public String getDataType(int aVarIndex, int aInsIndex) throws RevEngineException {
     ...
     * @throws RevEngineException Thrown in case of any problem.
     */
    public final String declare(int aVarIndex, int aInsIndex) throws RevEngineException {
        ...
        if (!ent.isDeclared()) {
            ...
            ent.declareVariable();
            return imports.getClassName(Helper.getJavaDataType(declareType, false));
        } else {
            return null;
        }
    }
    ...
    private String genName(String aType, int aVarIndex) {
        ...
        aType = imports.getClassName(Helper.getJavaDataType(aType, true));
        if (basicType) {
