...
@Component("Path")
public class PropertiesHandlerStrategyPath extends PropertiesHandlerStrategy {
    ...
    private static final String PROPERTIES_HANDLER_STRATEGY_NAME = PropertiesHandlerStrategy
            .PROPERTIES_HANDLER_STRATEGY_PATH;
    ...
    public Properties getProperties()
        ...
        properties = propertiesHandlerUtils.getHandler(fileInPath, true).getProperties();
