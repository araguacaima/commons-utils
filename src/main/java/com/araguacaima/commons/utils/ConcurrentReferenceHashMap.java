...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public boolean containsKey(Object key) {
        Reference<K, V> ref = getReference(key, Restructure.WHEN_NECESSARY);
        Entry<K, V> entry = (ref != null ? ref.get() : null);
        return (entry != null && com.araguacaima.commons.utils.ObjectUtils .nullSafeEquals(entry.getKey(), key));
    }
    ...
    public boolean remove(Object key, final Object value) {
        Boolean result = doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_AFTER, TaskOption.SKIP_IF_EMPTY) {
            ...
            protected Boolean execute(Reference<K, V> ref, Entry<K, V> entry) {
                if (entry != null && com.araguacaima.commons.utils.ObjectUtils.nullSafeEquals(entry.getValue(), value)) {
                    if (ref != null) {
                        ref.release();
                    }
                    return true;
    ...
    public boolean replace(K key, final V oldValue, final V newValue) {
        Boolean result = doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_BEFORE, TaskOption.SKIP_IF_EMPTY) {
            @Override
            protected Boolean execute(Reference<K, V> ref, Entry<K, V> entry) {
                if (entry != null && com.araguacaima.commons.utils.ObjectUtils.nullSafeEquals(entry.getValue(), oldValue)) {
            ...
            while (currRef != null) {
                if (currRef.getHash() == hash) {
                    ...
                    if (entry != null) {
                        ...
                        if (com.araguacaima.commons.utils.ObjectUtils.nullSafeEquals(entryKey, key)) {
                            return currRef;
                        }
                    }
                }
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public final boolean equals(Object other) {
            ...
            return (com.araguacaima.commons.utils.ObjectUtils.nullSafeEquals(getKey(), otherEntry.getKey()) &&
                    com.araguacaima.commons.utils.ObjectUtils.nullSafeEquals(getValue(), otherEntry.getValue()));
        }

        @Override
        public final int hashCode() {
            return (com.araguacaima.commons.utils.ObjectUtils.nullSafeHashCode(this.key) ^ com.araguacaima.commons.utils.ObjectUtils.nullSafeHashCode(this.value));
        }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                ...
                if (otherEntry != null) {
                    return com.araguacaima.commons.utils.ObjectUtils.nullSafeEquals(otherEntry.getValue(), otherEntry.getValue());
                }
            }
            return false;
        }
     ...
     */
    private final class SoftEntryReference<K, V> extends SoftReference<Entry<K, V>> implements Reference<K, V> {
     ...
     */
    private final class WeakEntryReference<K, V> extends WeakReference<Entry<K, V>> implements Reference<K, V> {
