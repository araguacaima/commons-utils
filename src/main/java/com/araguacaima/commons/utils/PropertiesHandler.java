...
public class PropertiesHandler {
    ...
    private PropertiesHandler(File propertiesFile, Class clazz) throws PropertiesUtilException {
     ...
     */
    private Properties loadConfig(String logFileSourceName) throws PropertiesUtilException {
     ...
     * @throws PropertiesUtilException en caso de no conseguir el archivo o de ocurrir otro error
     */
    private Properties loadConfig(String logFileSourceName, ClassLoader cl) throws PropertiesUtilException {
        Properties properties = new Properties();
        URL resource;
