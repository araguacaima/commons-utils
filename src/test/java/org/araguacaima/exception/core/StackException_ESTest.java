...
public class StackException_ESTest extends StackException_ESTest_scaffolding {
    ...
    public void test01()
            throws Throwable {
        Severity.getSeverity("org.araguacaima.exception.core.StackException");
        StackException stackException0 = new StackException("org.araguacaima.exception.core.StackException",
                (Severity) null,
                "org.araguacaima.exception.core.StackException");
        stackException0.add("org.araguacaima.exception.core.StackException");
        stackException0.remove("org.araguacaima.exception.core.StackException");
        stackException0.remove("org.araguacaima.exception.core.StackException");
    }
    ...
    public void test15()
            throws Throwable {
        Severity severity0 = mock(Severity.class, new ViolatedAssumptionAnswer());
        StackException stackException0 = new StackException("org.araguacaima.exception.core.ApplicationException",
                severity0);
        Severity severity1 = mock(Severity.class, new ViolatedAssumptionAnswer());
        StackException stackException1 = new StackException("org.araguacaima.exception.core.ApplicationException",
                severity1,
                "");
        Consumer<String> consumer0 = (Consumer<String>) mock(Consumer.class, new ViolatedAssumptionAnswer());
    ...
    public void test17()
        ...
        Severity severity1 = mock(Severity.class, new ViolatedAssumptionAnswer());
        stackException0.size();
        StackException stackException3 = new StackException("", severity1, "org.araguacaima.exception.core.Severity");
